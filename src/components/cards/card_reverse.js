   ...
   render(){
      ...
      return(
         <svg className="card-reverse-component" onClick={this.props.onClick}
            ...
            <g id="Layer_3">
               <path id="XMLID_5_" className="c0" d="M146.7 243.8H12c-6.6 0-12-5.4-12-12V12C0 5.4 5.4 0 12 0h134.7c6.6 0 12 5.4 12 12v219.8c0 6.6-5.4 12-12 12z"/></g><g id="Layer_1">
